...
const BodySystem = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'description',
            render: (text: string) => <span className="text-gray-700 line-clamp-2 max-w-[300px]">{text}</span>,
        },
        {
            title: 'Actions',
            key: 'actions',
    ...
    return (
        <div>
            ...
            <Table dataSource={BodySystemData} columns={columns} pagination={{ pageSize: 7 }} />
        </div>
    );
};
