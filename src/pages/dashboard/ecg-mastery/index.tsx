...
import SubcategoryFormModal from './ECGMasteryCategoryForm';

export default function ECGMasteryMainTopic() {
            ...
            <div className="mb-8 flex items-center justify-between ">
                ...
                <div className="flex gap-3">
                    <Button
                        ...
                        onClick={() => navigate('/ecg-mastery/practice-questions')}
                    >
                        Practice Questions
                    </Button>
                    <Button
                        className="!h-[40px] !bg-primary !text-white"
                        icon={<PlusOutlined />}
            ...
            {mainTopics.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ps-2">
                    {mainTopics?.map((s: any, i: number) => (
                        <Link key={i} to={`/ecg-mastery/${s.title}`} style={{ textDecoration: 'none' }}>
                            <Card hoverable>
