...
import SubcategoryFormModal from './CheatSheetsCategoryForm';

export default function CheatSheetsMainTopic() {
    ...
    return (
        <div className="">
            <div className="mb-8 flex items-center justify-between ">
                <div>
                    <HeaderTitle title={'Cheat Sheets'} />
            ...
            {mainTopics.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 ps-2">
                    {mainTopics?.map((s: any, i: number) => (
                        <Link key={i} to={`/cheat-sheets/${s.title}`} style={{ textDecoration: 'none' }}>
                            <Card hoverable>
